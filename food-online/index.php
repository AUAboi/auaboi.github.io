    ...
    <main class="relative bg-orange main-frontpage">
      ...
      <div class="absolute ml-3 top-0 mt-16 sm:mt-40 md:mt-32 lg:mt-64">
        ...
        <div class="mt-6 sm:ml-3 cursor-pointer">
          <a
            href="category.php"
            class="bg-yellow-400 transition-colors hover:bg-yellow-600 text-black text-sm sm:text-lg sm:py-2 sm:px-4 font-bold mr-3 py-1 px-2 rounded-full"
          >
            Browse Categories
          </a>
          <a
            href="menu.php"
            class="border cursor-pointer transition-colors border-yellow-600 hover:bg-yellow-600 text-white text-sm sm:text-lg sm:py-2 sm:px-4 font-bold py-1 px-2 rounded-full"
          >
            Menu
          </a>
        </div>
      </div>
      <img src="assets/bg-showcase.jpg" alt=""/>
      <section>
        <article>
      ...
      <section class="my-4 flex w-full">
        <article class="w-full text-center">
          ...
          <div class="fb-page desktop" data-href="https://www.facebook.com/cafepyalafsd/" data-tabs="timeline" data-width="500" data-height="" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/cafepyalafsd/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/cafepyalafsd/">Cafe Pyala</a></blockquote></div>
          <div class="fb-page mobile" data-href="https://www.facebook.com/cafepyalafsd/" data-tabs="timeline" data-width="250" data-height="" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/AUAW-with-cousins-1585210981740306/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/AUAW-with-cousins-1585210981740306/">AUAW with cousins</a></blockquote></div>          </div>
        </article>
      </section>
      <div data-aos="zoom-out-down" data-aos-duration="1500" class="font-extrabold sm:text-3xl shadow-xl text-2xl md:text-5xl m-6 fancy-font">
