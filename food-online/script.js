...
function loadDishes(catId) {
  ...
  xhr.open('GET', '/cafe-payala/dist/admin/ajax/dishnames.php?category-id=' + catId, true);
...
function loadStatus(catId, statusSpan) {
  var xhr = new XMLHttpRequest();
  xhr.open('GET', '/cafe-payala/dist/admin/ajax/categorystatus.php?category-id=' + catId, true);
...
function changeStatus(id, status) {
  ...
  var xhr = new XMLHttpRequest();
  xhr.open('GET', '/cafe-payala/dist/admin/ajax/changestatus.php?id=' + id + '&status=' + status, true);
